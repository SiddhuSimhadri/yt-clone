      ...
      <div className="flex h-5 items-center">
        ...
        <div className="group flex items-center">
          <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
            ...
            <input 
              type='text'
              className="bg-transparent outline-none text-white pr-5 pl-5 ml:pl-0 w-44 md:group-focus-within:pl-0 md:w-64 lg:w-[500px]"
        ...
        <div className="flex items-center">
          <div className="hidden md:flex">
            ...
            <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
              <img src="https://source.boringavatars.com/beam/120/Stefan?colors=264653,f4a261,e76f51" alt='profile'/>
            </div>
        </div>
    </div>
  )
